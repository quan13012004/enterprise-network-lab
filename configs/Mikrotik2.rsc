...
#
/interface vrrp
add authentication=simple interface=ether3 name=vrrp1 version=2
/interface list
add name=WAN_LIST
...
add address=172.16.16.3/24 interface=ether3 network=172.16.16.0
add address=30.0.0.1/30 interface=ether4 network=30.0.0.0
add address=10.0.3.2/30 interface=ether5 network=10.0.3.0
add address=10.0.1.2/30 interface=ether6 network=10.0.1.0
add address=172.16.16.1 interface=vrrp1 network=172.16.16.0
add address=20.0.1.1/30 interface=ether7 network=20.0.1.0
/ip dhcp-client
add interface=ether1
/ip firewall address-list
add address=192.168.0.0/16 list=LAN_NET
add address=172.16.16.0/24 list=LAN_NET
/ip firewall filter
...
add action=accept chain=forward dst-address=100.100.100.2 protocol=icmp \
    src-address=192.168.100.2 src-address-list=""
add action=drop chain=forward
/ip firewall mangle
add action=accept chain=prerouting dst-address-list=LAN_NET log=yes
add action=mark-connection chain=prerouting dst-address-list=!LAN_NET log=yes \
...
add action=mark-routing chain=prerouting connection-mark=ISP3_conn log=yes \
    new-routing-mark=to_ISP3 passthrough=no src-address-list=LAN_NET
add action=mark-routing chain=prerouting connection-mark=ISP4_conn log=yes \
    new-routing-mark=to_ISP4 passthrough=no src-address-list=LAN_NET
/ip firewall nat
add action=masquerade chain=srcnat out-interface-list=WAN_LIST
add action=dst-nat chain=dstnat dst-address=20.0.1.1 dst-port=80 log=yes \
    protocol=tcp to-addresses=172.16.16.100 to-ports=80
add action=dst-nat chain=dstnat dst-address=30.0.0.1 dst-port=80 log=yes \
    protocol=tcp to-addresses=172.16.16.100 to-ports=80
/ip route
add check-gateway=ping disabled=no distance=2 dst-address=0.0.0.0/0 gateway=\
    30.0.0.2 pref-src="" routing-table=main scope=30 suppress-hw-offload=no \
    target-scope=10
add check-gateway=ping disabled=no distance=10 dst-address=0.0.0.0/0 gateway=\
    20.0.1.2 pref-src="" routing-table=main scope=30 suppress-hw-offload=no \
    target-scope=10
add check-gateway=ping disabled=no distance=1 dst-address=0.0.0.0/0 gateway=\
    30.0.0.2 pref-src="" routing-table=to_ISP3 scope=30 suppress-hw-offload=\
    no target-scope=10
add check-gateway=ping disabled=no distance=1 dst-address=0.0.0.0/0 gateway=\
